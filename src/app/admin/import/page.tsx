    ...
    <div className="section">
      <div className="container-wide max-w-2xl">
        ...
        <p className="mt-4 text-sm leading-relaxed text-neutral-600">
          Lädt alle Bilder von der alten Joomla-Seite (Galerie, Post-Cover) nach MinIO hoch und
          schreibt Beiträge, Alben, Fotos und Veranstaltungen frisch in die Datenbank. Bilder werden
          unter dem Prefix{" "}
